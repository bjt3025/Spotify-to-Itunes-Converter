...
def spotify_MP3():
    ...
    for item in song_list:
        ...
        # Create a thread for the download_and_convert method
...
def song_info_recorder(sp):
    ...
    limit = 10 # I believe 50 is the max
    ...
    if music_download == 'playlist':
        ...
        if all_playlist == True:
            ...
            for playlist_name, ID in playlist_dict.items():
                ...
                saved_tracks = sp.playlist_items(playlist_id = ID, limit=100)["items"]
        ...
        #Download one playlist    
            ...
            saved_tracks = sp.playlist_items(playlist_id = desired_playlist_id, limit=100)["items"]
